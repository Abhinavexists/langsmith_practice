...
os.environ['LANGSMITH_PROJECT'] = 'graph_langgraph'
...
def evaluate_language(state: UPSCState):
    ...
    out: EvaluationSchema = structured_model.invoke(prompt)
...
@traceable(name="evaluate_thought", tags=["dimension:clarity"], metadata={"dimension": "clarity_of_thought"})
